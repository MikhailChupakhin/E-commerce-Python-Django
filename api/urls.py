...
from .views.orders_views import CheckoutAUTHAPIView, OrderDetailAPIView, OrderListAPIView, CheckoutNOAUTHAPIView
from .views.products_views import (BaseAPIView, IndexAPIView, ProductsListAPIView, CategoryProductsListAPIView,
                                   ...
                                   ChangeComparisonAPIView, ComparisonAPIView)
...
urlpatterns = [
    ...
    path('orders/checkout/noauth/', CheckoutNOAUTHAPIView.as_view(), name='checkout_noauth'),
